...
<html>
<head>
<script language="javascript" type="text/javascript" src="${ctx}/static/js/jquery-3.1.1.min.js"></script>
...
<div class="pages">
  ...
  <div data-page="form" class="page">
   ...
   <form action="${ctx}/auth/reg.do" id="reg-form" method="post" class="ajax-submit store-data">
          ...
          <li>
            <div class="item-content">
              ...
              <div class="item-inner"> 
                ...
                <div class="item-input">
                  <span id="pre_headimg" style="width:100px; height:100px; border-radius:50%; overflow:hidden;">
                  		<img src="" id="headimg" width="100px;" style="width:100px; height:100px; border-radius:50%; overflow:hidden;">
                  </span>
                  <span style="display: none">
	                  <input type="file" id="headfile" name="file" accept="image/*" />
          ...
          <li class="align-top">
            <div class="item-content">
              ...
              <div class="item-inner"> 
                ...
                <div class="item-input">
                  <textarea name="declaration"></textarea>
                </div>
              </div>
            </div>
          </li>
