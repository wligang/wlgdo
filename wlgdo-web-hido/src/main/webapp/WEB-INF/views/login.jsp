							...
							<div class="page">
								<div class="page-content login-screen-content">
									...
									<form>
												...
												<li class="item-content">
													<div class="item-inner">
														...
														<div class="item-input">
															<input type="text" name="accname" AutoComplete="off"
										...
										<div class="list-block">
											<ul>
												<li><a href="#" class="item-link list-button sign-btn">Sign
														In</a>
											</ul>
											<div class="list-block-label">
												<p>
													如果你还没有Hido账号，点击<a href="#" class="list-button sign-up">Sign
														Up</a>注册
												</p>
												<p>
													<a href="#" class="close-login-screen"> </a>
												</p>
											</div>
										</div>
									</form>
			...
			success:function(data){
				if(data && data.retCd==0){
					...
					if(location.href.indexOf("?")>1 && location.href.indexOf("=")>2){
						...
						window.location.href="${ctx}/mob/forward?id=index";
					}
				}else{
